...
int main() {
    ...
    std::filesystem::path output_path = "/mnt/c/Users/zhenh/trace_recon/Output_illum.txt";

    trace_reconstruction_benchmark<120> bench(clusters_path, centers_path, output_path, true);
